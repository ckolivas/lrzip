...
static inline unsigned history_page_slot(i64 offset)
{
	/* Mix aligned offsets so regular page strides use different slots. */
	return ((uint64_t)offset * UINT64_C(11400714819323198485)) >>
